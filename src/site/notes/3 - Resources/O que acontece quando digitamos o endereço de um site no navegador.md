---
{"dg-publish":true,"dg-path":"O que acontece quando digitamos o endereço de um site no navegador.md","permalink":"/o-que-acontece-quando-digitamos-o-endereco-de-um-site-no-navegador/","created":"2023-12-06T18:38:40.000-03:00","updated":"2026-01-23T14:24:57.369-03:00"}
---
...
1. [[3 - Resources/O que acontece quando digitamos o endereço de um site no navegador#Resolução DNS\|Resolução DNS]]
2. [[3 - Resources/O que acontece quando digitamos o endereço de um site no navegador#Estabelecimento de uma conexão TCP\|Estabelecimento de uma conexão TCP]]
3. [[3 - Resources/O que acontece quando digitamos o endereço de um site no navegador#Envio e processamento da requisição HTTP\|Envio e processamento da requisição HTTP]]
4. [[3 - Resources/O que acontece quando digitamos o endereço de um site no navegador#Geração e envio da resposta\|Geração e envio da resposta]]
5. [[3 - Resources/O que acontece quando digitamos o endereço de um site no navegador#Renderização do site\|Renderização do site]]
6. [[3 - Resources/O que acontece quando digitamos o endereço de um site no navegador#Exibição do site\|Exibição do site]]
## Resolução DNS
